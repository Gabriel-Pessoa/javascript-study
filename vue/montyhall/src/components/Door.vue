...
export default {
  ...
  data: function() {
    //função para que cada componentes tenha sua própria instância criando um novo objeto
    return {
      open: false,
      selected: false,
...
:root {
    ...
    --selected-door: 5px solid yellow;
}
...
.door-frame.selected {
    border-top: var(--selected-door);
    border-left: var(--selected-door);
    border-right: var(--selected-door);
}
